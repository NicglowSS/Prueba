import mnist_loader #(trabajar con la base de datos)
import pickle #(leer informacion de la memoria)
import matplotlib.pyplot as plt
import numpy as np
from matplotlib.image import imread
import network #(red neuronal)
...
imtest=imread('Numero4.jpg') #Leemos nuestra imagen
